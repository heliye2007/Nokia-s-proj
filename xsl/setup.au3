...
Func install_pycrypto()
	Local $pid=ShellExecute ( ".\pycrypto-2.6.win32-py2.7.exe")
	Do 
		Sleep(1000)
	...
	Do
		Sleep(500)
	Until ControlCommand("Setup","","Click the Finish button to exit the Setup wizard.","IsVisible")
	WinActivate("Setup")
	Sleep(500)
...
Func install_pywin32()
    RunWait("msiexec /qb /l* vc_python-log.txt /i VCForPython27.msi")
	Local $pid=ShellExecute ( ".\pywin32-219.win32-py2.7.exe")
	Do 
		Sleep(1000)
	Until (WinExists("Setup pywin32-219") And WinExists("Setup"))
	ControlClick("Setup","",12324,"left")
	Sleep(500)
	ControlClick("Setup","",12324,"left")
	Sleep(500)
	...
	Do
		Sleep(500)
	Until ControlCommand("Setup","",12325,"IsVisible")
	Sleep(500)
	WinActivate("Setup")
	ControlClick("Setup","",12325,"left")
	ProcessClose($pid)
...
Func install_wxpython()
    Local $pid=ShellExecute ( ".\wxPython2.8-win32-unicode-2.8.12.1-py27.exe")
    Do
        Sleep(1000)
    Until WinExists("Setup - wxPython2.8-unicode-py27")
    Local $hWnd = WinWait("Setup - wxPython2.8-unicode-py27")
    ControlClick($hWnd, "", "[CLASS:TNewButton; INSTANCE:1]","left")
    Sleep(500)
    ControlCommand($hWnd, "", "[CLASS:TNewRadioButton; INSTANCE:1]", "Check", "")
    Sleep(500)
    ControlClick($hWnd, "", "&Next >","left")
	Sleep(500)
    ControlClick($hWnd, "", "&Next >","left")
    Sleep(2000)
    ;path does exist
    ...
    ;reinstall by the way of uninstall
        ...
        Do
			Sleep(500)
		Until ControlCommand($hWnd, "", "TNewComboBox1","IsVisible")
    Endif
